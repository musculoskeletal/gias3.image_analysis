...
def haar3D4(integralImage, X, size):
	...
	s1 = integralImage.getSum(x,y,z, l/2,w/2,h) + integralImage.getSum(x+l/2,y+w/2,z, l/2,w/2,h)
	s2 = integralImage.getSum(x,y+w/2,z, l/2,w/2,h) + integralImage.getSum(x+l/2,y,z, l/2,w/2,h)
	return s1, s2
...
def haar3D5(integralImage, X, size):
	...
	s1 = integralImage.getSum(x,y,z, l,w/2,h/2) + integralImage.getSum(x,y+w/2,z+h/2, l,w/2,h/2)
	s2 = integralImage.getSum(x,y+w/2,z, l,w/2,h/2) + integralImage.getSum(x,y,z+h/2, l,w/2,h/2)
	return s1, s2
...
def haar3D6(integralImage, X, size):
	...
	s1 = integralImage.getSum(x,y,z, l/2,w,h/2) + integralImage.getSum(x+l/2,y,z+h/2, l/2,w,h/2)
	s2 = integralImage.getSum(x,y,z+h/2, l/2,w,h/2) + integralImage.getSum(x+l/2,y,z, l/2,w,h/2)
	return s1, s2
...
def haar3D7(integralImage, X, size):
	...
	s1 =  integralImage.getSum(x,y,z, l/2,w/2,h/2) + integralImage.getSum(x+l/2,y+w/2,z, l/2,w/2,h/2)\
		+ integralImage.getSum(x,y+w/2,z+h/2, l/2,w/2,h/2) + integralImage.getSum(x+l/2,y,z+h/2, l/2,w/2,h/2)
	s2 =  integralImage.getSum(x,y+w/2,z, l/2,w/2,h/2) + integralImage.getSum(x+l/2,y,z, l/2,w/2,h/2)\
		+ integralImage.getSum(x,y,z+h/2, l/2,w/2,h/2) + integralImage.getSum(x+l/2,y+w/2,z+h/2, l/2,w/2,h/2)
	return s1, s2
